    ...
    >
      <div className="relative w-[500px] h-[35vh] bg-white p-5 rounded">
        ...
        <div className="absolute bottom-8 right-6 flex gap-4">
          <Button label="Cancel" onClick={() => onClose()} textColor="text-teal-500" bgcolor="bg-slate-50"/>
          <Button label="Disconnect" onClick={() => handleLogout()} textColor="text-slate-50" bgcolor="bg-teal-600"/>
        </div>
      </div>
    </div>
  );
